...
const MovieModal = memo(({ movie, onClose }: MovieModalProps) => {
  ...
  return (
    ...
    >
      <article
        className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-lg border border-[#3a352f] bg-[#1b1917] shadow-[0_28px_90px_rgba(0,0,0,0.55)]"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="relative">
          <div className="h-52 bg-[#2b2722] sm:h-64">
            {backdropUrl ? (
              <img
        ...
        <div className="grid gap-5 p-5 sm:grid-cols-[180px_1fr] sm:p-6">
          <div className="-mt-20 aspect-[2/3] overflow-hidden rounded-lg border border-[#4a433b] bg-[#2b2722] shadow-[0_16px_50px_rgba(0,0,0,0.42)] sm:-mt-24">
            {posterUrl ? (
          ...
          <div className="flex min-w-0 flex-col gap-4">
            ...
            <p className="text-base leading-7 text-[#e3d8cb]">
              {movie.overview || '등록된 줄거리가 없습니다.'}
            </p>

            <div className="flex flex-col gap-3 border-t border-[#3a352f] pt-4 sm:flex-row">
              <a
